window.onload = function pozovi() {
      ...
      const url = "http://localhost:3000/podaci";
      ...
      xhr.onreadystatechange = function () {
        if (xhr.readyState === 4 && xhr.status === 200) {
          ...
          cellText2 = document.createTextNode("Ime i prezime");
          ...
          for (let i = 0; i < json.length; ++i) {
            ...
            cellText = document.createTextNode(json[i].id);
            cell.appendChild(cellText);
            row.appendChild(cell);
            cell2 = document.createElement("td");
            cellText2 = document.createTextNode(json[i]['ime i prezime']);
            cell2.appendChild(cellText2);
            row.appendChild(cell2);
